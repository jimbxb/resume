...
{2019 - Present}
{
    ...
    Further responsibilities include grading a large number of student's exams and assignments. \newline
}
...
\entry{Scalr.io -- UniHack'21 Project}
{2021}
{
    First-prize winning UniHack'21 submission built with my team over the course of 48 hours. 
    Scalr.io offers a platform where users can upload and utilise machine learning models through a simple to use API or web interface,
